    ...
    def sample(self, features, max_length=30):
        ...
        with torch.no_grad():
            ...
            for t in range(max_length):
                ...
                # Choose the most likely word from the vocabulary.
                word = torch.argmax(output_logits, axis=1)

                # Update overall caption and our current caption.
